...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="container">
        <h1>Saved Intern</h1>
        <p>Show all the interns (student) bookmarked by the recruiter</p>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <?php if (! empty($interns)) : ?>
        ...
        <div class="card p-4 shadow">
          ...
          <h5>Details</h5>
            <ul>
            <li>Institution : <?php echo $intern['institution']; ?></li>
            <li>Program : <?php echo $intern['program']; ?></li>
            <li>Prefer Location : <?php echo $intern['preferLocation']; ?></li>
