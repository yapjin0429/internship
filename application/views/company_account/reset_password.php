...
<body>
  ...
  <div class="container">
    ...
    <form class="form-horizontal" method="post" action="<?php echo site_url('company/account/reset_password/'.$code); ?>">
      ...
      <div class="row">
        <p class="offset-2 col-4">
          <a href="<?php echo site_url('company/account/login'); ?>"> Back to Login</a>
        </p>
      </div>
